...
export default function PaymentForm({ theme = 'modern' }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save to backend FIRST (if it fails, do not save locally or show success)
      ...
      // Only save locally if the API request succeeds
        ...
        {!generatedLink ? (
          ...
          <div className="space-y-6 animate-[fadeIn_0.5s_ease-out]">
            ...
            <div className="grid grid-cols-3 gap-3">
              {/* WhatsApp */}
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`Aura Payments Payment Link:\n${generatedLink}`)}`}
                target="_blank"
              ...
              {/* Telegram */}
              <a
                href={`https://t.me/share/url?url=${encodeURIComponent(generatedLink)}&text=${encodeURIComponent('Aura Payments Payment')}`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Gmail */}
              <a
                href={`https://mail.google.com/mail/?view=cm&fs=1&su=${encodeURIComponent('Aura Payments Receipt')}&body=${encodeURIComponent(`Here is your payment link via Aura Payments: ${generatedLink}`)}`}
                target="_blank"
                rel="noopener noreferrer"
